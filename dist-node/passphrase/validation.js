...
var countPassphraseWhitespaces = (exports.countPassphraseWhitespaces = function countPassphraseWhitespaces(
	passphrase,
) {
...
var countPassphraseWords = (exports.countPassphraseWords = function countPassphraseWords(
	passphrase,
) {
	return passphrase.split(' ').filter(Boolean).length;
});

var countUppercaseCharacters = (exports.countUppercaseCharacters = function countUppercaseCharacters(
	passphrase,
) {
...
var locateUppercaseCharacters = (exports.locateUppercaseCharacters = function locateUppercaseCharacters(
	passphrase,
) {
	var positions = [];
...
var locateConsecutiveWhitespaces = (exports.locateConsecutiveWhitespaces = function locateConsecutiveWhitespaces(
	passphrase,
) {
	var positions = [];
...
var getPassphraseValidationErrors = (exports.getPassphraseValidationErrors = function getPassphraseValidationErrors(
	passphrase,
	wordlist,
) {
	...
	if (
		!_bip2.default.validateMnemonic(
			passphrase,
			wordlist || _bip2.default.wordlists.english,
		)
	) {
		var validationError = {
