...
var getUserAgent = function getUserAgent() {
	...
	var systemInformation =
		_os2.default.platform() +
		' ' +
		_os2.default.release() +
		'; ' +
		_os2.default.arch() +
		(locale ? '; ' + locale : '');
	return (
		...
		[
			{
				...
				value: function initialize(nodes) {
					...
					if (
						(typeof providedOptions === 'undefined'
							? 'undefined'
							: (0, _typeof3.default)(providedOptions)) !== 'object' ||
					...
					this.headers = (0, _assign2.default)(
						{},
						commonHeaders,
					...
					this.nodes = nodes;
					this.bannedNodes = [].concat(
						(0, _toConsumableArray3.default)(options.bannedNodes || []),
					);
		...
		[
			{
				...
				value: function createMainnetAPIClient(options) {
					return new APIClient(
						...
						(0, _assign2.default)(
							{},
							{ nethash: _liskConstants.MAINNET_NETHASH },
							options,
						),
					);
				},
			},
			{
				...
				value: function createTestnetAPIClient(options) {
					return new APIClient(
						...
						(0, _assign2.default)(
							{},
							{ nethash: _liskConstants.TESTNET_NETHASH },
							options,
						),
					);
				},
			},
			{
				...
				value: function createBetanetAPIClient(options) {
					return new APIClient(
						...
						(0, _assign2.default)(
							{},
							{ nethash: _liskConstants.BETANET_NETHASH },
							options,
						),
					);
				},
