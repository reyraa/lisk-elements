	...
	return function apiHandler() {
		...
		if (urlParams.length > 0 && args.length < urlParams.length) {
			return _promise2.default.reject(
				new Error(
					'This endpoint must be supplied with the following parameters: ' +
						urlParams.toString(),
				),
			);
		}
		...
		var data = (0, _assign2.default)(
			...
			(0, _typeof3.default)(args[urlParams.length]) === 'object'
		...
		var resolvedURLObject = urlParams.reduce(function(accumulator, param, i) {
			return (0,
			_assign2.default)({}, accumulator, (0, _defineProperty3.default)({}, param, args[i]));
		}, {});

		var requestData = {
			method: method,
			url: (0, _utils.solveURLParams)(
