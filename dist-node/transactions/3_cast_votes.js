...
var castVotes = function castVotes(_ref) {
	...
	(0, _utils.validatePublicKeys)(
		[].concat(
			(0, _toConsumableArray3.default)(votes),
			(0, _toConsumableArray3.default)(unvotes),
		),
	);

	var recipientId = passphrase
		? _cryptography2.default.getAddressAndPublicKeyFromPassphrase(passphrase)
				.address
		: null;
	...
	var allVotes = [].concat(
		(0, _toConsumableArray3.default)(plusPrependedVotes),
		(0, _toConsumableArray3.default)(minusPrependedUnvotes),
	);
