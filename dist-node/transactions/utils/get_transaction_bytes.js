...
var checkRequiredFields = (exports.checkRequiredFields = function checkRequiredFields(
	requiredFields,
	data,
) {
...
var getAssetDataForTransferTransaction = (exports.getAssetDataForTransferTransaction = function getAssetDataForTransferTransaction(
	_ref,
) {
	var data = _ref.data;
...
var getAssetDataForRegisterSecondSignatureTransaction = (exports.getAssetDataForRegisterSecondSignatureTransaction = function getAssetDataForRegisterSecondSignatureTransaction(
	_ref2,
) {
...
var getAssetDataForRegisterDelegateTransaction = (exports.getAssetDataForRegisterDelegateTransaction = function getAssetDataForRegisterDelegateTransaction(
	_ref3,
) {
...
var getAssetDataForCastVotesTransaction = (exports.getAssetDataForCastVotesTransaction = function getAssetDataForCastVotesTransaction(
	_ref4,
) {
...
var getAssetDataForRegisterMultisignatureAccountTransaction = (exports.getAssetDataForRegisterMultisignatureAccountTransaction = function getAssetDataForRegisterMultisignatureAccountTransaction(
	_ref5,
) {
...
var getAssetDataForCreateDappTransaction = (exports.getAssetDataForCreateDappTransaction = function getAssetDataForCreateDappTransaction(
	_ref6,
) {
	var dapp = _ref6.dapp;
...
var getAssetDataForTransferIntoDappTransaction = (exports.getAssetDataForTransferIntoDappTransaction = function getAssetDataForTransferIntoDappTransaction(
	_ref7,
) {
...
var getAssetDataForTransferOutOfDappTransaction = (exports.getAssetDataForTransferOutOfDappTransaction = function getAssetDataForTransferOutOfDappTransaction(
	_ref8,
) {
...
var getAssetBytes = (exports.getAssetBytes = function getAssetBytes(
	transaction,
) {
	return {
...
var checkTransaction = (exports.checkTransaction = function checkTransaction(
	transaction,
) {
...
var getTransactionBytes = function getTransactionBytes(transaction) {
	...
	var transactionSenderPublicKey = _cryptography2.default.hexToBuffer(
		senderPublicKey,
	);
	var transactionRequesterPublicKey = requesterPublicKey
		? _cryptography2.default.hexToBuffer(requesterPublicKey)
		: Buffer.alloc(0);

	var transactionRecipientID = recipientId
		? _cryptography2.default.bigNumberToBuffer(
	...
	if (
		amountBigNum.gte(
			(0, _browserifyBignum2.default)(
				_liskConstants.MAX_TRANSACTION_AMOUNT,
			).plus(1),
		)
	) {
	...
	var transactionSignature = signature
		? _cryptography2.default.hexToBuffer(signature)
		: Buffer.alloc(0);

	var transactionSecondSignature = signSignature
		? _cryptography2.default.hexToBuffer(signSignature)
		: Buffer.alloc(0);
