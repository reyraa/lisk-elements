...
var isGreaterThanMaxTransactionAmount = function isGreaterThanMaxTransactionAmount(
	amount,
) {
	return amount.cmp(_liskConstants.MAX_TRANSACTION_AMOUNT) > 0;
};

var convertBeddowsToLSK = (exports.convertBeddowsToLSK = function convertBeddowsToLSK(
	beddowsAmount,
) {
...
var convertLSKToBeddows = (exports.convertLSKToBeddows = function convertLSKToBeddows(
	lskAmount,
) {
...
var prependPlusToPublicKeys = (exports.prependPlusToPublicKeys = function prependPlusToPublicKeys(
	publicKeys,
) {
...
var prependMinusToPublicKeys = (exports.prependMinusToPublicKeys = function prependMinusToPublicKeys(
	publicKeys,
) {
	return publicKeys.map(function(publicKey) {
		return '-' + publicKey;
