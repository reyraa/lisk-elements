...
var validatePublicKey = (exports.validatePublicKey = function validatePublicKey(
	publicKey,
) {
    ...
    *
    */
var checkPublicKeysForDuplicates = (exports.checkPublicKeysForDuplicates = function checkPublicKeysForDuplicates(
	publicKeys,
) {
...
var validatePublicKeys = (exports.validatePublicKeys = function validatePublicKeys(
	publicKeys,
) {
	return (
...
var validateKeysgroup = (exports.validateKeysgroup = function validateKeysgroup(
	keysgroup,
) {
...
var validateAddress = (exports.validateAddress = function validateAddress(
	address,
) {
	...
	if (
		addressAsBignum.cmp(
			(0, _browserifyBignum2.default)(_liskConstants.MAX_ADDRESS_NUMBER),
		) > 0
	) {
		throw new Error(
