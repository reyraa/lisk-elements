...
function signRawTransaction(_ref) {
	...
	var _cryptography$getAddr = _cryptography2.default.getAddressAndPublicKeyFromPassphrase(
			passphrase,
		),
	...
	var transactionWithProperties = (0, _assign2.default)(
		{},
		transaction,
		propertiesToAdd,
	);

	return (0, _prepare_transaction2.default)(
