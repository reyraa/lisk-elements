 ...
 *
 */
var signTransaction = (exports.signTransaction = function signTransaction(
	transaction,
	passphrase,
) {
...
var multiSignTransaction = (exports.multiSignTransaction = function multiSignTransaction(
	transaction,
	passphrase,
) {
...
var verifyTransaction = (exports.verifyTransaction = function verifyTransaction(
	transaction,
	secondPublicKey,
) {
	...
	var transactionHash = (0, _get_transaction_hash2.default)(
	...
	var signature = secondSignaturePresent
		? transaction.signSignature
		: transaction.signature;

	var verified = _cryptography2.default.verifyData(
		transactionHash,
		signature,
		publicKey,
	);
