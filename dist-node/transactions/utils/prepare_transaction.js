 ...
 *
 */
var secondSignTransaction = function secondSignTransaction(
	transactionObject,
	secondPassphrase,
) {
	return (0, _assign2.default)({}, transactionObject, {
		signSignature: (0, _sign_and_verify.signTransaction)(
			transactionObject,
			secondPassphrase,
		),
	});
...
var prepareTransaction = function prepareTransaction(
	transaction,
	passphrase,
	secondPassphrase,
) {
