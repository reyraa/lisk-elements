...
var getPrivateAndPublicKeyBytesFromPassphrase = (exports.getPrivateAndPublicKeyBytesFromPassphrase = function getPrivateAndPublicKeyBytesFromPassphrase(
	passphrase,
) {
	var hashed = (0, _hash2.default)(passphrase, 'utf8'); // :: Is getSha256Hash the same as hash function?
    ...
    *
    */
var getPrivateAndPublicKeyFromPassphrase = (exports.getPrivateAndPublicKeyFromPassphrase = function getPrivateAndPublicKeyFromPassphrase(
	passphrase,
) {
	var _getPrivateAndPublicK = getPrivateAndPublicKeyBytesFromPassphrase(
			passphrase,
		),
...
var getAddressAndPublicKeyFromPassphrase = (exports.getAddressAndPublicKeyFromPassphrase = function getAddressAndPublicKeyFromPassphrase(
	passphrase,
) {
...
var getAddressFromPassphrase = (exports.getAddressFromPassphrase = function getAddressFromPassphrase(
	passphrase,
) {
