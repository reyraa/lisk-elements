...
var encryptMessageWithPassphrase = (exports.encryptMessageWithPassphrase = function encryptMessageWithPassphrase(
	message,
	passphrase,
	recipientPublicKey,
) {
	...
	var convertedPrivateKey = (0, _convert.convertPrivateKeyEd2Curve)(
		senderPrivateKeyBytes,
	);
	var recipientPublicKeyBytes = (0, _convert.hexToBuffer)(recipientPublicKey);
	var convertedPublicKey = (0, _convert.convertPublicKeyEd2Curve)(
		recipientPublicKeyBytes,
	);
	var messageInBytes = _tweetnacl2.default.util.decodeUTF8(message);

	var nonce = _tweetnacl2.default.randomBytes(24);
	var cipherBytes = _tweetnacl2.default.box(
		messageInBytes,
		nonce,
		convertedPublicKey,
		convertedPrivateKey,
...
var decryptMessageWithPassphrase = (exports.decryptMessageWithPassphrase = function decryptMessageWithPassphrase(
	cipherHex,
	nonce,
	passphrase,
	senderPublicKey,
	...
	try {
		var decoded = _tweetnacl2.default.box.open(
			cipherBytes,
			nonceBytes,
			convertedPublicKey,
			convertedPrivateKey,
		);
		return _tweetnacl2.default.util.encodeUTF8(decoded);
	} catch (error) {
...
var getKeyFromPassword = function getKeyFromPassword(
	...
	return _crypto2.default.pbkdf2Sync(
		password,
		salt,
...
var encryptAES256GCMWithPassword = function encryptAES256GCMWithPassword(
	plainText,
	password,
	iterations,
) {
...
var decryptAES256GCMWithPassword = function decryptAES256GCMWithPassword(
	_ref,
	password,
) {
	...
	var key = getKeyFromPassword(
		password,
		(0, _convert.hexToBuffer)(salt),
		iterations,
	);
